...
const DESI_ANALOGIES = {
  ...
  syntax_error: {
    urdu: "Agar aap bolo 'Agar main pass ho gaya' aur aage kuch na bolo, baat adhoori lagti hai. Colon batata hai ke ab action define hona hai.",
    mixed: "Agar tum 'if I pass' likho aur aage kuch na likho, statement incomplete hai. Colon batata hai ke action next hai.",
    english: "Saying 'if I pass' without finishing it is incomplete. The colon signals the action comes next."
  },

  indentation_error: {
    urdu: "Agar paragraph properly align na ho toh structure samajh nahi aata. Python mein indentation batata hai kaunsa code kis block ka part hai.",
    mixed: "If lines aligned na hon, structure break hota hai. Indentation defines block structure.",
    english: "If lines aren’t aligned, structure breaks. Indentation defines code blocks."
  },

  unexpected_indent: {
    urdu: "Achanak beech mein extra space de do jahan zaroorat nahi thi, toh flow toot jata hai. Python bhi confuse ho jata hai.",
    mixed: "Extra indentation jahan needed nahi ho, flow break ho jata hai.",
    english: "Unexpected indentation breaks the flow. Python gets confused."
  },

  missing_parenthesis: {
    urdu: "Function call start ki lekin close hi nahi kiya—baat adhoori reh gayi.",
    mixed: "Bracket open kiya but close nahi kiya—statement incomplete hai.",
    english: "You opened a bracket but never closed it. The statement is incomplete."
  },

  // ═══════ VARIABLES & TYPES ═══════

  undefined_variable: {
    urdu: "Naam liya kisi ka jo exist hi nahi karta—system ke paas uska reference hi nahi hai.",
    mixed: "Variable use kiya jo define hi nahi hua—system usay pehchanta nahi.",
    english: "You used a variable that was never defined."
  },

  type_error: {
    urdu: "Rupees aur kilograms ko add karna logical nahi hai. Types match na hon toh system reject karta hai.",
    mixed: "Different types ko mix kar rahe ho—system samajh nahi pata.",
    english: "Mixing incompatible types doesn’t make sense."
  },

  type_casting_issue: {
    urdu: "Number ko text samjhe bina use kar rahe ho—pehle convert karna parta hai.",
    mixed: "String ko number treat kar rahe ho without conversion.",
    english: "Using a string like a number without converting it."
  },

  null_reference: {
    urdu: "Contact save hi nahi hai aur aap call kar rahe ho—number exist nahi karta.",
    mixed: "Value None hai aur tum usay use kar rahe ho—data hai hi nahi.",
    english: "Trying to use a value that doesn’t exist (None)."
  },

  // ═══════ DATA STRUCTURES ═══════

  index_error: {
    urdu: "5 log hain aur tum 6th ko bula rahe ho—woh exist hi nahi karta.",
    mixed: "Index range ke bahar access kar rahe ho.",
    english: "Accessing an index that doesn’t exist."
  },

  key_error: {
    urdu: "Record mein 'name' hai aur tum 'Name' dhoond rahe ho—match nahi karega.",
    mixed: "Key exact match nahi karegi toh value nahi milegi.",
    english: "Key must match exactly."
  },

  empty_list_access: {
    urdu: "Khali list se item nikalne ki koshish kar rahe ho—andar kuch hai hi nahi.",
    mixed: "Empty list se element access kar rahe ho.",
    english: "Trying to access data from an empty list."
  },
  ...
  function_no_return: {
    ...
    mixed: "Function run hua but return nahi diya.",
    english: "Function ran but returned nothing."
  },

  wrong_arguments: {
    urdu: "Function ko galat input diya—andar ka logic us input ke liye bana hi nahi tha.",
    mixed: "Function ko wrong parameters diye.",
    english: "You passed incorrect arguments to the function."
  },

  too_many_arguments: {
    urdu: "Function 2 cheezon ke liye bana tha, tum 5 de rahe ho—system reject karega.",
    mixed: "Expected less arguments but got more.",
    english: "Too many arguments were provided."
  },

  // ═══════ LOGIC & FLOW ═══════

  logic_error: {
    urdu: "Rule sahi hai lekin implement galat kiya—result wrong aata hai.",
    mixed: "Logic galat apply hua hai.",
    english: "Logic is incorrect even though code runs."
  },

  infinite_loop: {
    urdu: "Exit condition nahi hai toh process kabhi rukega hi nahi.",
    mixed: "Loop ke paas stop condition nahi hai.",
    english: "No exit condition means infinite execution."
  },

  off_by_one: {
    urdu: "Ek step zyada ya kam le liya—result slightly wrong ho gaya.",
    mixed: "Loop ek extra ya ek kam iteration chala.",
    english: "Loop runs one step too many or too few."
  },

  // ═══════ OOP ═══════

  attribute_error: {
    urdu: "Object se aisi cheez maang rahe ho jo uske paas hai hi nahi.",
    mixed: "Object ke paas wo attribute exist nahi karta.",
    english: "Object doesn’t have that attribute."
  },

  method_not_called: {
    urdu: "Function ka naam likha lekin call hi nahi kiya—kaam start hi nahi hua.",
    mixed: "Function reference diya but call nahi kiya.",
    english: "Function was referenced but never called."
  },

  constructor_error: {
    urdu: "Object banate waqt required cheezain di hi nahi—andar setup incomplete reh gaya.",
    mixed: "Constructor ko required values nahi mili.",
    english: "Object initialization failed due to missing inputs."
  },

  // ═══════ ASYNC & ADVANCED ═══════

  async_error: {
    urdu: "Order diya aur turant lene chalay gaye—ready nahi milega.",
    mixed: "Async call ke baad wait nahi kiya.",
    english: "Didn’t wait for async result."
  },

  race_condition: {
    urdu: "Do log ek hi cheez ko ek sath change kar rahe hain—result unpredictable ho jata hai.",
    mixed: "Multiple processes same data ko simultaneously modify kar rahe hain.",
    english: "Multiple operations conflict on shared data."
  },

  recursion_error: {
    urdu: "Base case nahi hai toh process repeat hota rahega jab tak crash na ho jaye.",
    mixed: "Function endlessly call hota rahega.",
    english: "Function calls itself endlessly."
  },

  stack_overflow: {
    urdu: "Itni zyada calls ho gayi ke system ka space hi khatam ho gaya.",
    mixed: "Too many function calls filled the stack.",
    english: "Stack memory exceeded due to too many calls."
  },

  memory_error: {
    urdu: "System ke paas aur data store karne ki jagah nahi bachi.",
    mixed: "Memory full ho gayi.",
    english: "System ran out of memory."
  }
};
